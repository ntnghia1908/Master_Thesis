...
if __name__ == "__main__":
    vlc = video_list_collector(save_dir='video_list_bunny8k',
                               base_link='http://ftp.itec.aau.at/datasets/mmsys12/BigBuckBunny/bunny_4s/',
                               form="bunny_4s_{0}kbit/bunny_4s{1}.m4s")
    vlc.seperate_trace()
    vlc.save()