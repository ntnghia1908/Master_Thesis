...
class DownFinishEvent(Event):
    def __init__(self, cur_time, downf_id, quality, cur_path, est_throughput, delay):
    ...
    def __str__(self):
        return "{}, DOWNF, downfID: {}, quality: {}, path: {}, est_throughput: {}, delay: {}".\
            format(self.cur_time, self.downf_id, self.quality, self.cur_path, self.est_throughput, self.delay)
...
class InactiveFinishEvent(Event):
    def __init__(self, cur_time, cur_path,  playing_id=None):
        super().__init__(cur_time=cur_time, event_type=Event.INACTIVEF)
        # self.playing_id = playing_id
        self.cur_path = cur_path

    def __str__(self):
        return "{}, INACTIVEF, cur_path: {}".format(self.cur_time, self.cur_path)
