...
from menv_baseline_schedule_single import Env
...
class PPOEvaluator(BaseEvaluator):
    ...
    def evaluate(self, seed, params):
        ...
        self.model.learn(total_timesteps=NUM_STEP_PER_EP*self.EVAL_EPS,
                         callback=WandbCallback_bestModel(verbose=1,  log_dir=self.log_dir, model_save_freq=1000,
                                                          model_save_path="./models/PPOEvaluator"+str(self.start_time)+"_Single_seed"+seed))
        end_time = time.time()
