...
9. scheduling
10. new state: lastmodel HISTORY actions, not lastmodel HISTORY chunks
...
class Env(gym.Env):
    ...
    def __init__(self, schedule_type, bitrate_lists, video_trace='../utility/video_list_bunny8k',
        ...
        self.state = dict(
            ...
            # last_path_state1=gym.spaces.Discrete(2), # status of path1. is_active is 1.
            # last_path_state2=gym.spaces.Discrete(2), # status of path1. is_active is 1.
        )
    ...
    def reset(self):
        ...
        # self.time_line.add(InactiveFinishEvent(self.VIDEO_CHUNK_LEN, cur_path=Path.PATH2))
        ...
        self.state = dict(
            ...
            # last_path_state1=self.path_state1,   # status of path1. initially is active.
            # last_path_state2=self.path_state2, # status of path2. initially is inactive.
        )
    ...
    def action_masks(self):
        ...
        # path_state_mask = np.ones(self.PATH_STATE, dtype=bool)
        chunk_mask[self.pick_next_segment()] = True
        # return np.concatenate((chunk_mask, quality_mask, path_state_mask),axis=None)
    ...
    def step(self, action):
        if self.multi_discrete:
            # next_down_chunk, down_quality, is_active = action
        ...
        self.time_line.add(DownFinishEvent(cur_time=cur_event.cur_time+delay, downf_id=down_id,
                                               quality=down_quality, cur_path=cur_event.cur_path, est_throughput=segment_size/delay, delay=delay))
        ...
        self.state = dict(
            ...
            delay_path1=self.down_delay1,
            # delay_path2=self.down_delay2,
            # last_path_state1=int(self.path_state1),  # status of path1. initially is active.
            # last_path_state2=int(self.path_state2),  # status of path2. initially is inactive.
        )
